    ...
    makeOptionCards(votingConfig) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (let option in votingConfig.options) {
                cards.push(botbuilder_1.CardFactory.heroCard(votingConfig.options[option].name, [], [
                    {
                        type: 'postBack',
                        title: 'vote!',
        ...
        return __awaiter(this, void 0, void 0, function* () {
            if (turnContext.activity.type === botbuilder_1.ActivityTypes.Message) {
                ...
                switch (command) {
                    ...
                    case 'vvv': {
                        //const message = await this.makeOptionCards(votingConfig);
                        yield turnContext.sendActivity(yield this.makeOptionCards(votingConfig));
                        break;
                    }
