...
(function (VOTE_COMMANDS) {
    ...
    VOTE_COMMANDS["HELP"] = "help";
    VOTE_COMMANDS["SHOW"] = "show";
            ...
            if (turnContext.activity.type === botbuilder_1.ActivityTypes.Message) {
                ...
                switch (command) {
                    ...
                    case VOTE_COMMANDS.RATE: {
                        yield this.handleRate(userInput, turnContext);
                        break;
                    }
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (showigSubject) {
                ...
                if (img) {
                    ...
                    yield turnContext.sendActivity(`Nothing to show`).catch(() => { console.log('error'); });
                }
            }
            else {
    ...
    sendWelcomeMessage(turnContext) {
        return __awaiter(this, void 0, void 0, function* () {
            if (turnContext.activity && turnContext.activity.membersAdded) {
                yield turnContext.sendActivity(`hello!`);
            }
        });
    }
}
